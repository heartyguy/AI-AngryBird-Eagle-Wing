package main.java.biz.k11i.xgboost.gbm;

import java.io.IOException;

import main.java.biz.k11i.xgboost.tree.RegTree;
import main.java.biz.k11i.xgboost.util.FVec;
import main.java.biz.k11i.xgboost.util.ModelReader;
...
public class GBTree extends GBBase {
	...
	public double predictSingle(FVec feat, int ntree_limit) {
		if (mparam.num_output_group != 1) {
			throw new IllegalStateException("Can't invoke predictSingle() because this model outputs multiple values: "
	...
	static class ModelParam {
		...
		/*
		 * ! \brief how many output group a single instance can produce this
		 * affects the behavior of number of output we have: suppose we have n
		 * instance and k group, output will be k*n
		 */

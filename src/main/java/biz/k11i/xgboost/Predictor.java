package main.java.biz.k11i.xgboost;

import java.io.IOException;
import java.io.InputStream;

import main.java.biz.k11i.xgboost.gbm.GradBooster;
import main.java.biz.k11i.xgboost.learner.ObjFunction;
...
public class Predictor {
	 ...
	 *            feature vector
	 * @param output_margin
	 *            whether to only predict margin value instead of transformed
	 *            prediction
	 * @return prediction values
	 */
	 ...
	 *            prediction
	 * @param ntree_limit
	 *            limit the number of trees used in prediction
	 * @return prediction values
	 */

package main.java.biz.k11i.xgboost.learner;
...
public class ObjFunction {
	...
	/**
	 * Uses Jafama's {@link FastMath#exp(double)} instead of
	 * {@link Math#exp(double)}.
	 *
	 * @param useJafama
	 *            {@code true} if you want to use Jafama's
	 *            {@link FastMath#exp(double)}, or {@code false} if you don't
	 *            want to use it but JDK's {@link Math#exp(double)}.
	 */

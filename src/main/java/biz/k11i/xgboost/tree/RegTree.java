package main.java.biz.k11i.xgboost.tree;
...
public class RegTree {
	...
	static class Param {
		...
		/*
		 * ! \brief leaf vector size, used for vector tree used to store more
		 * than one dimensional information in tree
		 */
	...
	static class Node {
		...
		// split feature index, left split or right split depends on the highest
		// bit
